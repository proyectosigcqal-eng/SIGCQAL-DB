...
-- changeset ErickRivera:5-crear-tabla-sustantiva-quejas-ari dbms:postgresql runOnChange:true
-- comment: Creacion de la tabla quejas_ari removiendo el error de sintaxis de la letra z.
